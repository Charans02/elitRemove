        ...
        <section className="flex flex-col gap-5 !pt-[20px] !pb-[190px] md:!pb-[100px] md:relative md:flex-row md:gap-[32.01px] md:!pt-[35px] xl:justify-between xl:gap-0 xl:!pb-[200px] 2xl:!pt-[60px]">
          <div className="flex h-fit max-w-[710px] flex-col items-center gap-4 md:items-start lg:items-start lg:gap-6 xl:items-start">
            ...
            <Text className="text-center text-[14px] leading-[23px] md:text-left md:text-[16px] lg:text-left lg:text-[21px] lg:leading-[26px] xl:text-left">
              <span className="font-bold leading-[33px]">
          ...
          <Image
            ...
            height={737}
            quality={100}
            className="static mx-auto w-full max-w-[280px] translate-y-4 scale-x-[1] object-contain md:absolute md:top-[30px] md:right-[5%] md:max-w-[340px] md:translate-y-0 lg:max-w-[400px] lg:translate-y-0 xl:top-[55px] xl:max-w-[500px]"
            priority
          />
        </section>
      </div>
